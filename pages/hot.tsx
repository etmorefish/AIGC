  ...
  return (
    <main>
      <div className="hot__cards-wrapper">
        <div className="border border-amber-500 rounded-lg bg-sky-400">
          ...
          <div className="px-4">
            <div>
              <span className="inilne-block items-center justify-center w-4  h-4 mr-2 text-lg rounded-8 bg-red-400 ">
                1
              </span>
